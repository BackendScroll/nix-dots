...
Item {
    ...
    Rectangle {
        ...
        property Item targetItem:
            root.currentIndex >= 0 && root.currentIndex < contentItem.children.length
                ? contentItem.children[root.currentIndex]
                : null
        ...
        AnimatedTabIndexPair {
            ...
            idx1Duration: 50
            idx2Duration: 200
            index: activeIndicator.targetItem
                ? activeIndicator.targetItem.x + activeIndicator.targetItem.width
                : 0
        }

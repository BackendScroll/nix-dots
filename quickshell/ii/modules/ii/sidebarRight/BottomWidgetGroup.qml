...
Rectangle {
    ...
    clip: true
    implicitHeight: collapsed ? collapsedBottomWidgetGroupRow.implicitHeight : 420
            ...
            Loader {
                ...
                Connections {
                    ...
                    function onSelectedTabChanged() {
                        if (root.previousIndex >= 0) {
                            tabSwitchBehavior.animation.down =
                                root.selectedTab > root.previousIndex;
                        }

                        root.previousIndex = root.selectedTab;
                        tabStack.source =
                            root.tabs[root.selectedTab].widget;
                    }
                }

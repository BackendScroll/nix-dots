    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            MaterialSymbol {
                text: Todo.errorMessage.length > 0
                    ...
                    : "task_alt"
                iconSize: 18
                color: Todo.errorMessage.length > 0
            ...
            StyledText {
                ...
                text: Todo.errorMessage.length > 0
                    ...
                    : (
                        Todo.busy
                            ? "Updating TaskNotes…"
                            : `${Todo.list.length} tasks • AeternumStrategion`
                    )
            ...
            TodoItemActionButton {
                tooltipText: "Refresh TaskNotes"
                enabled: !Todo.loading
            ...
            TodoItemActionButton {
                tooltipText: "Open TaskNotes view"
                onClicked: Todo.openTasksView()
        ...
        SwipeView {
            ...
            TaskList {
                ...
                emptyPlaceholderText: Todo.errorMessage.length > 0
                    ? Todo.errorMessage
                    : "Finished TaskNotes will go here"
                taskList: Todo.list
                    .map(function(item, i) { return Object.assign({}, item, {originalIndex: i}); })
                    .filter(function(item) { return item.done; })
            }
        ...
        Rectangle { // The dialog
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    DialogButton {
                        buttonText: "Add to TaskNotes"
                        enabled: todoInput.text.length > 0 && !Todo.busy

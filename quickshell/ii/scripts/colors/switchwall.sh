...
switch() {
    ...
    "${ILLOGICAL_IMPULSE_PYTHON:-python3}" "$SCRIPT_DIR/generate_colors_material.py" "${generate_colors_material_args[@]}" \
...
main() {
    ...
    detect_scheme_type_from_image() {
        local img="$1"
        "${ILLOGICAL_IMPULSE_PYTHON:-python3}" "$SCRIPT_DIR"/scheme_for_image.py "$img" 2>/dev/null | tr -d '\n'
    }

...
-- The QuickShell configuration is installed at ~/.config/quickshell/ii, so its
-- scripts live one directory deeper than the config root.
local qsScripts = "$HOME/.config/quickshell/ii/scripts"
local qsIpcCall = "qs -c ipc call"
...
hl.bind("SUPER + SUPER_L", hl.dsp.exec_cmd("desktopctl launcher"))
hl.bind("SUPER + SUPER_R", hl.dsp.exec_cmd("desktopctl launcher"))
...
hl.bind("CTRL + SUPER + ALT + T", hl.dsp.exec_cmd("desktopctl wallpaper-random"))
hl.bind(
	"CTRL + SUPER + SHIFT + D",
...
hl.bind(
	"SUPER + V",
	hl.dsp.exec_cmd("desktopctl clipboard-history"),
	{ description = "Utilities: Clipboard history >> clipboard" }
)
-- Emoji picking has no standalone fallback; QuickShell owns it entirely
-- (see the quickshell:overviewEmojiToggle binding above).
...
-- Reverse image search has no standalone fallback; QuickShell owns it.
...
hl.bind(
	"SUPER + SHIFT + C",
	hl.dsp.exec_cmd("desktopctl color-picker"),
...
hl.bind("SUPER + SHIFT + R", hl.dsp.exec_cmd("desktopctl record-toggle"), { locked = true })
hl.bind("SUPER + ALT + R", hl.dsp.global("quickshell:regionRecord"), { locked = true })
hl.bind("SUPER + ALT + R", hl.dsp.exec_cmd("desktopctl record-toggle"), { locked = true })
hl.bind("CTRL + ALT + R", hl.dsp.exec_cmd("desktopctl record-toggle --fullscreen"), { locked = true })
hl.bind(
	"SUPER + SHIFT + ALT + R",
	hl.dsp.exec_cmd("desktopctl record-toggle --fullscreen --sound"),
	{ locked = true, description = "Utilities: Record screen (with sound)" }
)
--# Fullscreen screenshot
hl.bind(
	"Print",
	hl.dsp.exec_cmd("desktopctl screenshot-screen"),
	{ locked = true, description = "Utilities: Screenshot >> clipboard" }
)
hl.bind(
	"CTRL + Print",
	hl.dsp.exec_cmd("desktopctl screenshot-screen --save"),
	{ locked = true, non_consuming = true, description = "Utilities: Screenshot >> clipboard & file" }
)
--# AI
hl.bind(
	"SUPER + SHIFT + ALT + mouse:273",
	hl.dsp.exec_cmd("desktopctl ai-selection"),
...
--##! Session
hl.bind("SUPER + L", hl.dsp.exec_cmd("desktopctl lock"), { description = "Session: Lock" })
hl.bind(
	"SUPER + SHIFT + L",
